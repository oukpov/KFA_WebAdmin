...
import 'Agency_new.dart';

class Menu_Agency extends StatefulWidget {
  const Menu_Agency({super.key});

  @override
  State<Menu_Agency> createState() => _MenuAutoState();
}
...
class _MenuAutoState extends State<Menu_Agency> {
  @override
                ...
                setState(() {
                  if (i == 0) {
                    Navigator.of(context).push(
                        MaterialPageRoute(builder: (context) => New_Agency()));
                  }
                  if (i == 1) {
                    Navigator.of(context).push(
                        MaterialPageRoute(builder: (context) => Agency_List()));
                  }
                });
              },
              child: Container(
