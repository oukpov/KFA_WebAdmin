...
import 'Edit_Approved.dart';

class Approved_List extends StatefulWidget {
  const Approved_List({super.key});

  @override
  State<Approved_List> createState() => _Assign_ListState();
}

class _Assign_ListState extends State<Approved_List> {
  @override
  void initState() {
    list();
    super.initState();
  ...
  Future<void> list() async {
    try {
      final response = await http.get(Uri.parse(
          'https://www.oneclickonedollar.com/laravel_kfa_2023/public/api/get_approved'));
...
class _DataSource extends DataTableSource {
  ...
  Future<void> delete(id) async {
    final response = await http.delete(Uri.parse(
        'https://www.oneclickonedollar.com/laravel_kfa_2023/public/api/delete_approved/${id.toString()}'));
    if (response.statusCode == 200) {
