...
class New_Assign extends StatefulWidget {
  ...
  @override
  State<New_Assign> createState() => _New_AgencyState();
}

class _New_AgencyState extends State<New_Assign> {
  String? name;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('New Assign'),
  ...
  Future<void> Assign_new() async {
    ...
    final url = await Uri.parse(
        'https://www.oneclickonedollar.com/laravel_kfa_2023/public/api/new_assign');
