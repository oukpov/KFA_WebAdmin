...
class EditVerbalAgent extends StatefulWidget {
  const EditVerbalAgent({
    super.key,
    required this.type,
    required this.listUser,
    required this.addNew,
    required this.listVerbal,
    required this.listVerbalLandbuilding,
    required this.index,
    required this.verbalImage,
  });
  ...
  final List listVerbalLandbuilding;
  final int index;
...
class _HomePageState extends State<EditVerbalAgent>
  ...
  Future<void> getCurrentLocation() async {
    ...
    setState(() {
      ...
      setState(() {
        ...
        verbalAgentModel.latlongLa = latLng.latitude.toString();
        verbalAgentModel.latlongLog = latLng.longitude.toString();
        findlocation(latLng);
      });
    });
  }
  ...
  void getValueToModel() {
    setState(() {
      listBuilding = widget.listVerbalLandbuilding;
      var item = widget.listVerbal[widget.index];
      verbalAgentModel.verbalId = item['verbal_id'];
      verbalAgentModel.verbalCode = item['verbal_code'];
      verbalAgentModel.titleDeedN = item['title_deedN'] ?? "";
      verbalAgentModel.underPropertyRight = item['under_property_right'];
      verbalAgentModel.referrenceN = item['referrenceN'];
      verbalAgentModel.landSize = item['land_size'];
      verbalAgentModel.buildingSize = item['building_size'];
      verbalAgentModel.issuedDate = item['issued_date'];
      verbalAgentModel.verbalPropertyId = item['verbal_property_id'];
      verbalAgentModel.verbalOwner = item['verbal_owner'];
      verbalAgentModel.verbalContact = item['verbal_contact'];
      verbalAgentModel.verbalDate = item['receivedate'];
      verbalAgentModel.receivedate = item['referrenceN'];
      verbalAgentModel.verbalAddress = item['verbal_address'];
      verbalAgentModel.verbalComment = item['verbal_comment'];
      verbalAgentModel.latlongLa = item['latlong_la'];
      verbalAgentModel.latlongLog = item['latlong_log'];
      verbalAgentModel.verbalUser = item['verbal_user'];
      verbalAgentModel.verbalCreatedDate = item['verbal_created_date'];
      verbalAgentModel.verbalImage = widget.verbalImage;
      verbalAgentModel.propertytypeName = item['property_type_name'] ?? "";
      List result = verbalAgentModel.verbalAddress!.split(", ");
      roadController.text = result[0] ?? "";
      provinceController.text = result[1] ?? "";
      ditrictController.text = result[2] ?? "";
      communeController.text = result[3] ?? "";
      referrenceNController.text = verbalAgentModel.referrenceN ?? "";
      titleDeedNController.text = verbalAgentModel.titleDeedN ?? "";
      underPropertyRightController.text =
          verbalAgentModel.underPropertyRight ?? "";
      ////////
      sizeLandController.text = verbalAgentModel.landSize ?? "";
      sizeBuildingController.text = verbalAgentModel.buildingSize ?? "";
      ownerController.text = verbalAgentModel.verbalOwner ?? "";
      contactController.text = verbalAgentModel.verbalContact ?? "";
    });
  }
  ...
  void searchComparable() {
    setState(() {
      ...
      if (comparedropdown2 == "" && typedrawerSe == false) {
        ...
        typedrawerSe = true;
        clearMarkeronly();
        findlocation(LatLng(double.parse(verbalAgentModel.latlongLa!),
            double.parse(verbalAgentModel.latlongLog!)));
  ...
  TextEditingController sizeLandController = TextEditingController();
  TextEditingController sizeBuildingController = TextEditingController();
  Widget addLandBuilding() {
    final verbalAgent =
        Get.put(VerbalAgents(iduser: widget.listUser[0]['agency'].toString()));
    // final verbalAgent =
    //     VerbalAgents(iduser: widget.listUser[0]['agency'].toString());
    return Column(
      children: [
        ...
        Padding(
          ...
          child: Container(
            ...
            height: (_byesData != null ||
                    get_bytes != null ||
                    widget.verbalImage != "No")
                ? hscreen + 150
                : hscreen,
            width: MediaQuery.of(context).size.width,
            decoration: BoxDecoration(
                  ...
                  child: SingleChildScrollView(
                    child: Column(
                      children: [
                                                        ...
                                                        onTap: () async {
                                                          if (_formKey
                                                            ...
                                                            setState(() {
                                                              ...
                                                              verbalAgentModel
                                                                      .referrenceN =
                                                                  referrenceNController
                                                                      .text;
                                                              verbalAgentModel
                                                                      .titleDeedN =
                                                                  titleDeedNController
                                                                      .text;
                                                              verbalAgentModel
                                                                      .underPropertyRight =
                                                                  underPropertyRightController
                        ...
                        if (verbalAgentModel.latlongLa != "")
                          InkWell(
                            onTap: () async {
                              launch(
                                'https://www.google.com/maps?q=${verbalAgentModel.latlongLa},${verbalAgentModel.latlongLog}',
                                forceSafariVC: false,
                                forceWebView: false,
                              );
                            },
                            child: Container(
                              ...
                              child: FadeInImage.assetNetwork(
                                ...
                                image:
                                    'https://maps.googleapis.com/maps/api/staticmap?center=${verbalAgentModel.latlongLa},${verbalAgentModel.latlongLog}&zoom=15&size=1080x920&maptype=hybrid&markers=color:red%7C%7C${verbalAgentModel.latlongLa},${verbalAgentModel.latlongLog}&key=AIzaSyCYY4ONLxyCkQkueOWSlu4TjuyCH3QNkQ8',
                              ),
                            ),
                          ),
                        Padding(
                          ...
                          children: [
                            Expanded(
                              ...
                              child: SizedBox(
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller: sizeLandController,
                                    onSaved: (value) {
                                      setState(() {
                                        sizeLandController.text = value!;
                                      });
                                    },
                                    decoration: InputDecoration(
                                      fillColor: kwhite,
                            ...
                            Expanded(
                              ...
                              child: SizedBox(
                                ...
                                child: Padding(
                                  padding:
                                      const EdgeInsets.fromLTRB(00, 0, 30, 0),
                                  child: TextFormField(
                                    controller: sizeBuildingController,
                                    onSaved: (value) {
                                      setState(() {
                                        sizeBuildingController.text = value!;
                                      });
                                    },
                                    decoration: InputDecoration(
                                      fillColor: kwhite,
                        ...
                        const SizedBox(height: 10),
                        DateComponents(
                          values: verbalAgentModel.issuedDate ?? "",
                          title: "Issued Date",
                          value: (value) {
                            setState(() {
                        ...
                        if (_byesData != null)
                          ...
                          SizedBox(
                            height: 150,
                            child: (widget.verbalImage != "No")
                                ? Image.memory(base64Decode(widget.verbalImage))
                                : const Text("No Image"),
                          ),
                        const SizedBox(height: 10.0),
                        Padding(
                              ...
                              Expanded(
                                ...
                                child: SizedBox(
                                  ...
                                  child: PropertySearch(
                                    value:
                                        verbalAgentModel.propertytypeName ?? "",
                                    h: sizeh,
                                    // pro: "Land",
                                    name: (value) {
                                      // propertyType = value;
