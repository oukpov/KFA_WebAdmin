...
//         'POST',
//         Uri.parse(
//             'https://www.oneclickonedollar.com/laravel_kfa_2023/public/api/customer/mutipleImage'));
//     request.headers['content-type'] = 'multipart/form-data';

//     request.fields['customerID'] = customercode!;

//     if (selectedImages.isNotEmpty) {
//       for (int i = 0; i < selectedImages.length; i++) {
//         request.files.add(http.MultipartFile.fromBytes(
//             'customerImage${i + 1}', selectedImages[i],
...
//     } else {
//       // Error during upload
//       print('Failed to upload images: ${res.reasonPhrase}');
//     }
//   }
...
//   int radom() {
//     String coderadoms =
//         '${int.parse(widget.idUsercontroller)}${Random().nextInt(9999)}';
//     coderadom = int.parse(coderadoms);

//     return coderadom;
//   }

//   void mainmutiple() async {
//     for (int i = 0; i < selectedImages.length; i++) {
//       coderadompost = radom();
//       imagemutiple(i, coderadompost.toString());
//     }
//   }

//   Future<void> imagemutiple(int index, String code) async {
//     var request = http.MultipartRequest(
//       'POST',
//       Uri.parse(
//           'https://www.oneclickonedollar.com/laravel_kfa_2023/public/api/customer/image/2012123'),
//     );
...
//     var dio = Dio();
//     var response = await dio.request(
//       'https://www.oneclickonedollar.com/laravel_kfa_2023/public/api/customer/images_gets/2012123',
//       options: Options(
//         method: 'GET',
//       ),
//     );
...
//                                 ),
//                                 sizebox10h,
//                                 titletexts('Customer Information'),
//                                 sizebox40h,
...
//                                   value: (value) {
//                                     setState(() {
//                                       customersize = double.parse(value);
//                                     });
//                                   },
//                                 ),
//                                 sizebox10h,
...
//                                   value: (value) {
//                                     setState(() {
//                                       customerBuildSize = double.parse(value);
//                                     });
//                                   },
//                                 ),
//                                 sizebox10h,
...
//                                   value: (value) {
//                                     setState(() {
//                                       secondpayment = double.parse(value);
