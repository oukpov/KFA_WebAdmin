// ignore_for_file: non_constant_identifier_names, prefer_const_constructors, avoid_print, unused_field
...
class Comparable_search_map_full extends StatefulWidget {
  const Comparable_search_map_full({
    super.key,
  ...
  @override
  State<Comparable_search_map_full> createState() => _SearchPlacesScreenState();
}

class _SearchPlacesScreenState extends State<Comparable_search_map_full> {
  String sendAddrress = '';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        backgroundColor: Color.fromARGB(255, 3, 123, 43),
        onPressed: () {
          // Navigator.push(context, MaterialPageRoute(
          //   builder: (context) {
          //     return list_save_detail(
          //       list: [],
          //     );
          //   },
          // ));
