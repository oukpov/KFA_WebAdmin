...
import 'package:web_admin/page/navigate_home/Comparable/newComparable/responsivenewcomparableget.dart';
import 'package:web_admin/page/navigate_home/Comparable/newComparable/responsiveupdate.dart';
import '../../../../screen/Property/Map/ToFromDate_ForSale.dart';

class List_newcomparable extends StatefulWidget {
  List_newcomparable({super.key, required this.name});
  final String name;
  @override
  State<List_newcomparable> createState() => _List_newcomparableState();
}
...
class _List_newcomparableState extends State<List_newcomparable> {
  int on_row = 20;
