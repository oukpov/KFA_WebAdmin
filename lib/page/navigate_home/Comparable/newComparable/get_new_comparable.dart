                                  ...
                                  Padding(
                                    ...
                                    child: Container(
                                      ...
                                      child: FadeInImage.assetNetwork(
                                        ...
                                        image:
                                            // 'https://maps.googleapis.com/maps/api/staticmap?center=${_list[widget.index]['latlong_la'].toString()},${_list[widget.index]['latlong_log'].toString()}&zoom=15&size=1080x920&maptype=hybrid&markers=color:red%7C%7C${_list[widget.index]['latlong_la'].toString()},${_list[widget.index]['latlong_log'].toString()}&key=AIzaSyCYY4ONLxyCkQkueOWSlu4TjuyCH3QNkQ8',
                                            'https://maps.googleapis.com/maps/api/staticmap?center=${(double.parse(_list[widget.index]['latlong_la'].toString()) < double.parse(_list[widget.index]['latlong_log'].toString())) ? "${_list[widget.index]['latlong_la'].toString()},${_list[widget.index]['latlong_log'].toString()}" : "${_list[widget.index]['latlong_log'].toString()},${_list[widget.index]['latlong_la'].toString()}"}&zoom=15&size=1080x920&maptype=hybrid&markers=color:red%7C%7C${(double.parse(_list[widget.index]['latlong_la'].toString()) < double.parse(_list[widget.index]['latlong_log'].toString())) ? "${_list[widget.index]['latlong_la'].toString()},${_list[widget.index]['latlong_log'].toString()}" : "${_list[widget.index]['latlong_log'].toString()},${_list[widget.index]['latlong_la'].toString()}"}&key=AIzaSyCYY4ONLxyCkQkueOWSlu4TjuyCH3QNkQ8',
                                      ),
                                    ),
                                  )
                                ],
