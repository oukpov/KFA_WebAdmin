                    ...
                    InkWell(
                      ...
                      child: Container(
                        ...
                        child: FadeInImage.assetNetwork(
                          ...
                          image:
                              'https://maps.googleapis.com/maps/api/staticmap?center=${(widget.listData[widget.index]['latlong_la'] < widget.listData[widget.index]['latlong_log']) ? "${widget.listData[widget.index]['latlong_la']},${widget.listData[widget.index]['latlong_log']}" : "${widget.listData[widget.index]['latlong_log']},${widget.listData[widget.index]['latlong_la']}"}&zoom=15&size=1080x920&maptype=hybrid&markers=color:red%7C%7C${(widget.listData[widget.index]['latlong_la'] < widget.listData[widget.index]['latlong_log']) ? "${widget.listData[widget.index]['latlong_la']},${widget.listData[widget.index]['latlong_log']}" : "${widget.listData[widget.index]['latlong_log']},${widget.listData[widget.index]['latlong_la']}"}&key=AIzaSyAJt0Zghbk3qm_ZClIQOYeUT0AaV5TeOsI',
                        ),
                      ),
                    ),
                  const SizedBox(height: 10),
