...
class UploadAboutUsImagePage extends StatefulWidget {
  const UploadAboutUsImagePage({Key? key}) : super(key: key);

  @override
  _UploadAboutUsImagePageState createState() => _UploadAboutUsImagePageState();
}

class _UploadAboutUsImagePageState extends State<UploadAboutUsImagePage> {
  ...
  Future<void> pickAndUploadImageWeb() async {
    ...
    try {
      ...
      var response = await dioClient.request(
        'https://www.oneclickonedollar.com/Demo_BackOneClickOnedollar/public/api/aboutusImage/addimage',
        options: dio.Options(
          method: 'POST',
          headers: headers,
        ),
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text("Upload Image About Us",
