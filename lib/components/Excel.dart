...
class ClassExcel extends StatefulWidget {
  final String username;
  final List list;
  const ClassExcel({super.key, required this.username, required this.list});
  @override
  State<ClassExcel> createState() => _ClassExcelState();
}

class _ClassExcelState extends State<ClassExcel> {
  @override
