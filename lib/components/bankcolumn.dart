...
class BankDropdowncolumn extends StatefulWidget {
  const BankDropdowncolumn({
    Key? key,
    required this.bank,
  ...
  final String? brn;
  @override
  State<BankDropdowncolumn> createState() => _BankDropdowncolumnState();
}

class _BankDropdowncolumnState extends State<BankDropdowncolumn> {
  var _list = [];
  var _branch = [];
  bool hasError = false;
