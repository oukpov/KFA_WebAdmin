// ignore_for_file: file_names, prefer_const_constructors, non_constant_identifier_names, avoid_print, use_build_context_synchronously, unused_local_variable
...
class _AddState extends State<Add> with SingleTickerProviderStateMixin {
                ...
                (value) async {
                  if (requestModelAuto.verbal.isEmpty) {
                    ...
                    if (value.message == "Save Successfully") {
                      ...
                      if (_byesData != null) {
                        imagebytes = _byesData;
                      } else {
                        imagebytes = get_bytes;
                      }
  ...
  Future<void> testComporessList() async {
    Uint8List list;
    if (_byesData != null) {
      list = _byesData!;
    } else {
  ...
  Future<dynamic> uploadImage_map() async {
  ...
  Future _asyncInputDialog(BuildContext context) async {
    return showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          scrollable: true,
          insetPadding: EdgeInsets.only(top: 5, left: 0, right: 5, bottom: 10),
          content: SizedBox(
