...
// import 'package:admin_web_kfa/api/contants.dart';
...
//     executiveapprove1status = TextEditingController(
//         text: widget.list[indexI]['executiveapprove1status'].toString());
//     executiveComment = TextEditingController(
//         text: widget.list[indexI]['executive_comment'].toString());
...
//             // Text('executiveValuationDate => ${executiveValuationDate.text}'),
//             // Text(
//             //     'executiveValuationIssueDate => ${executiveValuationIssueDate.text}'),
//             // Text('executivePurpose => ${executivePurpose.text}'),
//             // Text('executivePropertyTypeID => ${executivePropertyTypeID.text}'),
//             // Text('executiveZoneID => ${executiveZoneID.text}'),
//             // Text('executiveLandWidth => ${executiveLandWidth.text}'),
//             // Text('executiveLandLengh => ${executiveLandLengh.text}'),
//             // Text('executiveLandTotal => ${executiveLandTotal.text}'),
//             // Text('executiveLandPrice => ${executiveLandPrice.text}'),
//             // Text('executiveLandPricePer => ${executiveLandPricePer.text}'),
//             // Text('executiveMarketMin => ${executiveMarketMin.text}'),
//             // Text('executiveMarketMax => ${executiveMarketMax.text}'),
//             // Text('executivePropertyName => ${executivePropertyName.text}'),
//             // Text('executiveObligation => ${executiveObligation.text}'),
//             // Text('executiveBuilding => ${executiveBuilding.text}'),
//             // Text('executiveFire => ${executiveFire.text}'),
//             // Text('executiveFair => ${executiveFair.text}'),
//             // Text('executiveForced => ${executiveForced.text}'),
//             // Text('executiveProvinceID => ${executiveProvinceID.text}'),
//             // Text('executiveDistrictID => ${executiveDistrictID.text}'),
//             // Text('executiveCommuneID => ${executiveCommuneID.text}'),
//             // Text('executiveRoadTypeID => ${executiveRoadTypeID.text}'),
//             // Text('executiveRemark => ${executiveRemark.text}'),
//             // Text('executiveLon => ${executiveLon.text}'),
//             // Text('executiveLng => ${executiveLng.text}'),
//             // Text('executiveUser => ${executiveUser.text}'),
...
//           (customerID.text == 'null' || customerID.text == '')
//               ? null
//               : customerID.text,
//       "executive_valuation_date": (executiveValuationDate.text == 'null' ||
//               executiveValuationDate.text == '')
//           ? null
//           : executiveValuationDate.text,
//       "executive_valuation_issue_date":
//           (executiveValuationIssueDate.text == 'null' ||
//                   executiveValuationIssueDate.text == '')
//               ? null
//               : executiveValuationIssueDate.text,
//       "executive_purpose":
//           (executivePurpose.text == 'null' || executivePurpose.text == '')
//               ? null
//               : executivePurpose.text,
//       "executive_property_type_id": (executivePropertyTypeID.text == 'null' ||
//               executivePropertyTypeID.text == '')
//           ? null
//           : executivePropertyTypeID.text,
//       "executive_zone_id":
//           (executiveZoneID.text == 'null' || executiveZoneID.text == '')
//               ? null
//               : executiveZoneID.text,
//       "executive_land_width":
//           (executiveLandWidth.text == 'null' || executiveLandWidth.text == '')
//               ? null
//               : executiveLandWidth.text,
//       "executive_land_lengh":
//           (executiveLandLengh.text == 'null' || executiveLandLengh.text == '')
//               ? null
//               : executiveLandLengh.text,
//       "executive_land_total":
//           (executiveLandTotal.text == 'null' || executiveLandTotal.text == '')
//               ? null
//               : executiveLandTotal.text,
//       "executive_land_price":
//           (executiveLandPrice.text == 'null' || executiveLandPrice.text == '')
//               ? null
//               : executiveLandPrice.text,
//       "executive_land_price_per": (executiveLandPricePer.text == 'null' ||
//               executiveLandPricePer.text == '')
//           ? null
//           : executiveLandPricePer.text,
//       "executive_market_min":
//           (executiveMarketMin.text == 'null' || executiveMarketMin.text == '')
//               ? null
//               : executiveMarketMin.text,
//       "executive_market_max":
//           (executiveMarketMax.text == 'null' || executiveMarketMax.text == '')
//               ? null
//               : executiveMarketMax.text,
//       "executive_property_name": (executivePropertyName.text == 'null' ||
//               executivePropertyName.text == '')
//           ? null
//           : executivePropertyName.text,
//       "executive_obligation":
//           (executiveObligation.text == 'null' || executiveObligation.text == '')
//               ? null
//               : executiveObligation.text,
//       "executive_building":
//           (executiveBuilding.text == 'null' || executiveBuilding.text == '')
//               ? null
//               : executiveBuilding.text,
//       "executive_fire":
//           (executiveFire.text == 'null' || executiveFire.text == '')
//               ? null
//               : executiveFire.text,
//       "executive_fair":
//           (executiveFair.text == 'null' || executiveFair.text == '')
//               ? null
//               : executiveFair.text,
//       "executive_forced":
//           (executiveForced.text == 'null' || executiveForced.text == '')
//               ? null
//               : executiveForced.text,
//       "executive_province_id":
//           (executiveProvinceID.text == 'null' || executiveProvinceID.text == '')
//               ? null
//               : executiveProvinceID.text,
//       "executive_district_id":
//           (executiveDistrictID.text == 'null' || executiveDistrictID.text == '')
//               ? null
//               : executiveDistrictID.text,
//       "executive_commune_id":
//           (executiveCommuneID.text == 'null' || executiveCommuneID.text == '')
//               ? null
//               : executiveCommuneID.text,
//       "executive_road_type_id":
//           (executiveRoadTypeID.text == 'null' || executiveRoadTypeID.text == '')
//               ? null
//               : executiveRoadTypeID.text,
//       "executive_remark":
//           (executiveRemark.text == 'null' || executiveRemark.text == '')
//               ? null
//               : executiveRemark.text,
//       "executive_lon": (executiveLon.text == 'null' || executiveLon.text == '')
//           ? null
//           : executiveLon.text,
//       "executive_lng": (executiveLng.text == 'null' || executiveLng.text == '')
//           ? null
//           : executiveLng.text,
//       "executive_create_by":
//           (executiveUser.text == 'null' || executiveUser.text == '')
//               ? null
//               : executiveUser.text,
//       "building": builDing,
//       "appraiser": appraiser,
//       "conparable_map": conparableMap,
//     });
