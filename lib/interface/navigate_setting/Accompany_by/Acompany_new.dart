...
class New_Acompany extends StatefulWidget {
  ...
  @override
  State<New_Acompany> createState() => _New_AgencyState();
}

class _New_AgencyState extends State<New_Acompany> {
  String? name;
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('New Acompany'),
  ...
  Future<void> Assign_new() async {
    ...
    final url = await Uri.parse(
        'https://www.oneclickonedollar.com/laravel_kfa_2023/public/api/new_company');
