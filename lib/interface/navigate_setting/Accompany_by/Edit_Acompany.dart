...
class Edit_Accompany_by extends StatefulWidget {
  ...
  @override
  State<Edit_Accompany_by> createState() => _New_AgencyState();
}

class _New_AgencyState extends State<Edit_Accompany_by> {
  ...
  void initState() {
    ...
    _update_new = TextEditingController(
        text: '${widget.list[index_p]['Accompany_by_name']}');
  ...
  Future<void> Assign_new() async {
    Map<String, dynamic> payload = await {
      'Accompany_by_name': name.toString(),
    };
    final url = await Uri.parse(
        'https://www.oneclickonedollar.com/laravel_kfa_2023/public/api/update_company/${widget.list[index_p]['person_id']}');
