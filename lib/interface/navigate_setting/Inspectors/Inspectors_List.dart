...
import 'Edit_Inspectors.dart';

class Assign_List extends StatefulWidget {
  const Assign_List({super.key});

  @override
  State<Assign_List> createState() => _Assign_ListState();
}

class _Assign_ListState extends State<Assign_List> {
  @override
  void initState() {
    list();
    super.initState();
  ...
  Future<void> list() async {
    try {
      final response = await http.get(Uri.parse(
          'https://www.oneclickonedollar.com/laravel_kfa_2023/public/api/get_Inspectors'));
  ...
  Future<void> list_search() async {
    try {
      final response = await http.get(Uri.parse(
          'https://www.oneclickonedollar.com/laravel_kfa_2023/public/api/Inspectors_search?search=$search'));
      if (response.statusCode == 200) {
        final List<dynamic> jsonBody = jsonDecode(response.body);
        _list = jsonBody;
        setState(() {});
...
class _DataSource extends DataTableSource {
  ...
  Future<void> delete(id) async {
    final response = await http.delete(Uri.parse(
        'https://www.oneclickonedollar.com/laravel_kfa_2023/public/api/delete_Inspectors/${id.toString()}'));
    if (response.statusCode == 200) {
