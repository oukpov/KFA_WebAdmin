...
class _Assign_ListState extends State<Assign_List> {
  ...
  Future<void> list() async {
    try {
      final response = await http.get(Uri.parse(
          'https://www.oneclickonedollar.com/laravel_kfa_2023/public/api/get_Inspector'));
  ...
  Future<void> list_search() async {
    try {
      final response = await http.get(Uri.parse(
          'https://www.oneclickonedollar.com/laravel_kfa_2023/public/api/Inspector_search?search=$search'));
      if (response.statusCode == 200) {
        final List<dynamic> jsonBody = jsonDecode(response.body);
        _list = jsonBody;
        setState(() {});
...
class _DataSource extends DataTableSource {
  ...
  Future<void> delete(id) async {
    final response = await http.delete(Uri.parse(
        'https://www.oneclickonedollar.com/laravel_kfa_2023/public/api/delete_Inspector/${id.toString()}'));
    if (response.statusCode == 200) {
