...
import 'Inspector_new.dart';

class Menu_Inspector extends StatefulWidget {
  const Menu_Inspector({super.key});

  @override
  State<Menu_Inspector> createState() => _MenuAutoState();
}
...
class _MenuAutoState extends State<Menu_Inspector> {
  @override
