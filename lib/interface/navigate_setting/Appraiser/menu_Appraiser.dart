...
import 'Appraiser_list.dart';
import 'Appraiser_new.dart';

class Menu_Appraiser extends StatefulWidget {
  const Menu_Appraiser({super.key});

  @override
  State<Menu_Appraiser> createState() => _MenuAutoState();
}
...
class _MenuAutoState extends State<Menu_Appraiser> {
  @override
                ...
                setState(() {
                  if (i == 0) {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => New_Appraiser()));
                  }
                  if (i == 1) {
                    Navigator.of(context).push(MaterialPageRoute(
                        builder: (context) => Appraiser_List()));
                  }
                });
              },
              child: Container(
