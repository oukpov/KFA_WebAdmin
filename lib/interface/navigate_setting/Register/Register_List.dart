...
class Register_List extends StatefulWidget {
  const Register_List({super.key});

  @override
  State<Register_List> createState() => _Assign_ListState();
}

class _Assign_ListState extends State<Register_List> {
  @override
  void initState() {
    list();
    super.initState();
  ...
  Future<void> list() async {
    try {
      final response = await http.get(Uri.parse(
          'https://www.oneclickonedollar.com/laravel_kfa_2023/public/api/get_Register'));
...
class _DataSource extends DataTableSource {
  ...
  Future<void> delete(id) async {
    final response = await http.delete(Uri.parse(
        'https://www.oneclickonedollar.com/laravel_kfa_2023/public/api/delete_Register/${id.toString()}'));
    if (response.statusCode == 200) {
