...
class Edit_Register extends StatefulWidget {
  ...
  @override
  State<Edit_Register> createState() => _New_AgencyState();
}

class _New_AgencyState extends State<Edit_Register> {
  ...
  Future<void> Assign_new() async {
    ...
    final url = await Uri.parse(
        'https://www.oneclickonedollar.com/laravel_kfa_2023/public/api/update_Register/${widget.list[index_p]['person_id']}');
