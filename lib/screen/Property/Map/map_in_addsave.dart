...
class Map_verbal_addsave extends StatefulWidget {
  const Map_verbal_addsave({
    super.key,
  ...
  final double? lat;
  @override
  State<Map_verbal_addsave> createState() => _SearchPlacesScreenState();
}

class _SearchPlacesScreenState extends State<Map_verbal_addsave> {
  String sendAddrress = '';
